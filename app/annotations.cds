using { gnseo_STUDENTH21Srv } from '../srv/service.cds';

annotate gnseo_STUDENTH21Srv.CustomerMessage with @UI.HeaderInfo: { TypeName: 'Customer Message', TypeNamePlural: 'Customer Messages', Title: { Value: customerMessageID } };
annotate gnseo_STUDENTH21Srv.CustomerMessage with {
  ID @UI.Hidden @Common.Text: { $value: customerMessageID, ![@UI.TextArrangement]: #TextOnly }
};
annotate gnseo_STUDENTH21Srv.CustomerMessage with @UI.Identification: [{ Value: customerMessageID }];
annotate gnseo_STUDENTH21Srv.CustomerMessage with {
...
annotate gnseo_STUDENTH21Srv.CustomerMessage with @UI.LineItem: [
...
annotate gnseo_STUDENTH21Srv.CustomerMessage with @UI.FieldGroup #Main: {
...
annotate gnseo_STUDENTH21Srv.CustomerMessage with @UI.Facets: [
  { $Type: 'UI.ReferenceFacet', ID: 'Main', Label: 'General Information', Target: '@UI.FieldGroup#Main' }
];

annotate gnseo_STUDENTH21Srv.CustomerMessage with @UI.SelectionFields: [
  customerMessageID
];
